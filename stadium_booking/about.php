						...
						<h3><?php echo $concert['concert_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:15px">Teams : <?php echo $concert['cast']; ?></p>
									<p class="p-link" style="font-size:15px">Event date : <?php echo date('d-M-Y',strtotime($concert['release_date'])); ?></p>
									<p style="font-size:15px"><?php echo $concert['desc']; ?></p>
									<a href="<?php echo $concert['video_url']; ?>" target="_blank" class="watch_but">Popular Video</a>
								</div>
								<div class="clear"></div>
							</div>
