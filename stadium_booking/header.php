    ...
    <div class="header-top">
        <div class="wrap">
              <div  class="nav-wrap">
		       ...
		       <li><h1 style="color:powderblue;">Feel Every Moment Live!</h1></li>
		       <li><img src="images/sport.jfif" alt="" width="400" height="100"/></li>
...
<div class="block">
	...
	<div class="wrap">	
        <form action="process_search.php" id="reservation-form" method="post" onsubmit="myFunction()">
		       <fieldset>
		       	<div class="field" >
                                <input type="text"  placeholder="Search Events Here..." style="height:27px;width:500px"   id="search111" name="searching"> 
